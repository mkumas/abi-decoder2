...
# Install
```
npm install abi-decoder2
bower install abi-decoder2
```

# Instantiate
```js
<script src="bower_components/abi-decoder/dist/abi-decoder2.js"> // Javascript
const abiDecoder = require('abi-decoder2'); // NodeJS
```
...
const decodedData = abiDecoder2.decodeMethod(testData);
```
...
web3.eth.getTransactionReceipt("0x9199e262aaab0a6ec99558b3e9f42397c07a2bb9c6befb637643aebfb03cc32a", function(e, receipt) {
  const decodedLogs = abiDecoder2.decodeLogs(receipt.logs);
});
```
